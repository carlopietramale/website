...
$params = array();
$params["title"] = 'Bâo Deep Space Network';
$params["nick"] = "guest".rand(1,1000);  // setup the intitial nickname
$params['firstisadmin'] = false;
$params['admins'] = array( 'Carlo' => 'olrac111' );
...
<div class="content">
  <?php $chat->printChat(); ?><p style='color:red;font-weight:bold'>Notice: To authenticate, type /nick <i>[your username]</i> followed by /identify <i>[your password]</i></p>
